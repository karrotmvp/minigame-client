  ...
  return {
    ...
    async demandTownUsingPOST(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<BaseResponseUnit>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.demandTownUsingPOST(
          authority,
          createdAt,
          id,
          nickname,
 ...
 * @export
 */
export const GamePlayApiAxiosParamCreator = function (
  configuration?: Configuration
) {
  return {
    /**
    ...
    addCommentUsingPATCH: async (
      ...
      const localVarPath = `/api/games/{gameType}/comment`.replace(
        `{${'gameType'}}`,
        encodeURIComponent(String(gameType))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
     ...
     * @throws {RequiredError}
     */
    getUserCountByDailyUsingGET: async (
      gameType: 'GAME_KARROT' | 'GAME_2048',
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'gameType' is not null or undefined
      assertParamExists('getUserCountByDailyUsingGET', 'gameType', gameType);
      const localVarPath = `/api/games/{gameType}/daily-count`.replace(
        `{${'gameType'}}`,
        encodeURIComponent(String(gameType))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    updateScoreUsingPATCH: async (
      gameType: 'GAME_KARROT' | 'GAME_2048',
      requestDto: ScoreRequestDto,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'gameType' is not null or undefined
      ...
      const localVarPath = `/api/games/{gameType}/score`.replace(
        `{${'gameType'}}`,
        encodeURIComponent(String(gameType))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const GamePlayApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.addCommentUsingPATCH(
          gameType,
          requestDto,
          options
        );
     ...
     * @throws {RequiredError}
     */
    async getUserCountByDailyUsingGET(
      gameType: 'GAME_KARROT' | 'GAME_2048',
      options?: AxiosRequestConfig
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<BaseResponseint>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getUserCountByDailyUsingGET(
          gameType,
          options
        );
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateScoreUsingPATCH(
          gameType,
          requestDto,
          options
        );
 ...
 * @export
 */
export const GamePlayApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    addCommentUsingPATCH(
      gameType: 'GAME_KARROT' | 'GAME_2048',
      requestDto: CommentRequestDto,
      options?: any
    ): AxiosPromise<BaseResponseUnit> {
      return localVarFp
        .addCommentUsingPATCH(gameType, requestDto, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getUserCountByDailyUsingGET(
      gameType: 'GAME_KARROT' | 'GAME_2048',
      options?: any
    ): AxiosPromise<BaseResponseint> {
      return localVarFp
        .getUserCountByDailyUsingGET(gameType, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    updateScoreUsingPATCH(
      gameType: 'GAME_KARROT' | 'GAME_2048',
      requestDto: ScoreRequestDto,
      options?: any
    ): AxiosPromise<BaseResponseUnit> {
      return localVarFp
        .updateScoreUsingPATCH(gameType, requestDto, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class GamePlayApi extends BaseAPI {
   ...
   */
  public addCommentUsingPATCH(
    gameType: 'GAME_KARROT' | 'GAME_2048',
    requestDto: CommentRequestDto,
    options?: AxiosRequestConfig
  ) {
    return GamePlayApiFp(this.configuration)
      .addCommentUsingPATCH(gameType, requestDto, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof GamePlayApi
   */
  public getUserCountByDailyUsingGET(
    gameType: 'GAME_KARROT' | 'GAME_2048',
    options?: AxiosRequestConfig
  ) {
    return GamePlayApiFp(this.configuration)
 ...
 * @export
 */
export const GameTownApiAxiosParamCreator = function (
  configuration?: Configuration
) {
  return {
    /**
     ...
     * @throws {RequiredError}
     */
    getLeaderBoardByTownUsingGET: async (
      gameType: 'GAME_KARROT' | 'GAME_2048',
      month?: number,
      size?: number,
      week?: number,
      ...
      const localVarPath = `/api/games/{gameType}/towns/leaderboard`.replace(
        `{${'gameType'}}`,
        encodeURIComponent(String(gameType))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const GameTownApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getLeaderBoardByTownUsingGET(
      gameType: 'GAME_KARROT' | 'GAME_2048',
      month?: number,
      size?: number,
      week?: number,
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<BaseResponseListTownRankResponseDto>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getLeaderBoardByTownUsingGET(
          gameType,
          month,
          size,
          week,
 ...
 * @export
 */
export const GameTownApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
...
export class GameTownApi extends BaseAPI {
   ...
   */
  public getLeaderBoardByTownUsingGET(
    gameType: 'GAME_KARROT' | 'GAME_2048',
    month?: number,
    size?: number,
    week?: number,
    ...
    return GameTownApiFp(this.configuration)
      .getLeaderBoardByTownUsingGET(gameType, month, size, week, year, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
 ...
 * @export
 */
export const GameUserApiAxiosParamCreator = function (
  configuration?: Configuration
) {
  console.log('GameUserApiAxiosParamCreator', configuration);
  return {
    /**
     *
     * @summary 유저 리더보드 조회
     ...
     * @throws {RequiredError}
     */
    getLeaderBoardByUserUsingGET: async (
      gameType: 'GAME_KARROT' | 'GAME_2048',
      month?: number,
      size?: number,
      week?: number,
      ...
      const localVarPath = `/api/games/{gameType}/users/leaderboard`.replace(
        `{${'gameType'}}`,
        encodeURIComponent(String(gameType))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getMyBestScoreUsingGET: async (
      gameType: 'GAME_KARROT' | 'GAME_2048',
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'gameType' is not null or undefined
      assertParamExists('getMyBestScoreUsingGET', 'gameType', gameType);
      const localVarPath = `/api/games/{gameType}/users/me/best-score`.replace(
        `{${'gameType'}}`,
        encodeURIComponent(String(gameType))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getMyRankInfoUsingGET: async (
      gameType: 'GAME_KARROT' | 'GAME_2048',
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'gameType' is not null or undefined
      assertParamExists('getMyRankInfoUsingGET', 'gameType', gameType);
      const localVarPath = `/api/games/{gameType}/users/me`.replace(
        `{${'gameType'}}`,
        encodeURIComponent(String(gameType))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const GameUserApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getLeaderBoardByUserUsingGET(
      gameType: 'GAME_KARROT' | 'GAME_2048',
      month?: number,
      size?: number,
      week?: number,
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<BaseResponseListobject>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getLeaderBoardByUserUsingGET(
          gameType,
          month,
          size,
          week,
    ...
    async getMyBestScoreUsingGET(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<BaseResponseUserBestScoreDto>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getMyBestScoreUsingGET(
          gameType,
          options
        );
      return createRequestFunction(
    ...
    async getMyRankInfoUsingGET(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<BaseResponseUserInfoWithRankDto>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getMyRankInfoUsingGET(
          gameType,
          options
        );
      return createRequestFunction(
 ...
 * @export
 */
export const GameUserApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getMyBestScoreUsingGET(
      gameType: 'GAME_KARROT' | 'GAME_2048',
      options?: any
    ): AxiosPromise<BaseResponseUserBestScoreDto> {
      return localVarFp
        .getMyBestScoreUsingGET(gameType, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getMyRankInfoUsingGET(
      gameType: 'GAME_KARROT' | 'GAME_2048',
      options?: any
    ): AxiosPromise<BaseResponseUserInfoWithRankDto> {
      return localVarFp
        .getMyRankInfoUsingGET(gameType, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class GameUserApi extends BaseAPI {
   ...
   */
  public getLeaderBoardByUserUsingGET(
    gameType: 'GAME_KARROT' | 'GAME_2048',
    month?: number,
    size?: number,
    week?: number,
    ...
    return GameUserApiFp(this.configuration)
      .getLeaderBoardByUserUsingGET(gameType, month, size, week, year, options)
      .then((request) => request(this.axios, this.basePath));
  }
...
export const Oauth2ApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    karrotLoginUsingPOST: async (
      requestDto: KarrotCodeRequestDto,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'requestDto' is not null or undefined
  ...
  return {
    ...
    async karrotLoginUsingPOST(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<BaseResponseTokenDto>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.karrotLoginUsingPOST(
          requestDto,
          options
        );
      return createRequestFunction(
...
export const Oauth2ApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    karrotLoginUsingPOST(
      requestDto: KarrotCodeRequestDto,
      options?: any
    ): AxiosPromise<BaseResponseTokenDto> {
      return localVarFp
        .karrotLoginUsingPOST(requestDto, options)
        .then((request) => request(axios, basePath));
    },
  };
};
 ...
 * @export
 */
export const TownApiAxiosParamCreator = function (
  configuration?: Configuration
) {
  return {
    /**
  ...
  return {
    ...
    async getTownInfoUsingGET(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<BaseResponseTownDto>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getTownInfoUsingGET(regionId, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
 ...
 * @export
 */
export const TownApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
    ...
    getTownInfoUsingGET(
      ...
      return localVarFp
        .getTownInfoUsingGET(regionId, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class TownApi extends BaseAPI {
  ...
  public getTownInfoUsingGET(regionId: string, options?: AxiosRequestConfig) {
    return TownApiFp(this.configuration)
      .getTownInfoUsingGET(regionId, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const UserApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getUserCountUsingGET(
      options?: AxiosRequestConfig
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<BaseResponselong>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getUserCountUsingGET(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
