...
export const VisitorApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} uUID UUID
         * @param {string} regionId regionId
         * @param {'FEED' | 'NEAR_BY' | 'SHARE' | 'UNKNOWN'} [referer] referer
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        visitUsingPOST: async (uUID: string, regionId: string, referer?: 'FEED' | 'NEAR_BY' | 'SHARE' | 'UNKNOWN', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'uUID' is not null or undefined
...
export const VisitorApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async visitUsingPOST(uUID: string, regionId: string, referer?: 'FEED' | 'NEAR_BY' | 'SHARE' | 'UNKNOWN', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BaseResponseUnit>> {
...
export const VisitorApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        visitUsingPOST(uUID: string, regionId: string, referer?: 'FEED' | 'NEAR_BY' | 'SHARE' | 'UNKNOWN', options?: any): AxiosPromise<BaseResponseUnit> {
...
export class VisitorApi extends BaseAPI {
     ...
     * @memberof VisitorApi
     */
    public visitUsingPOST(uUID: string, regionId: string, referer?: 'FEED' | 'NEAR_BY' | 'SHARE' | 'UNKNOWN', options?: AxiosRequestConfig) {
