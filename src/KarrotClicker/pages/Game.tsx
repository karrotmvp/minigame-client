...
import GamePause from 'KarrotClicker/components/game/GamePause';
import React, { useEffect, useState } from 'react';
import Modal from 'react-modal';
import GameDirectionPopupModal from 'KarrotClicker/components/game/GameDirectionPopupModal';
import { commafy } from 'KarrotClicker/functions/numberFunctions';
import ClickAnimation from 'KarrotClicker/components/game/ClickAnimation';
import { useHistory } from 'react-router';
import { useAnalytics } from 'services/analytics';
import useClickCounter from 'KarrotClicker/hooks/useClickCounter';
import useUserData from 'KarrotClicker/hooks/useUserData';
import BigKarrot from 'KarrotClicker/components/game/BigKarrot';
...
import GameOver from 'KarrotClicker/components/game/GameOver';
